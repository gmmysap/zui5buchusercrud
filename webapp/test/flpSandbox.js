		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Crud Employee",
									"targetURL": "#zui5buchusercrud-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zui5buchusercrud-display": {
								"semanticObject": "zui5buchusercrud",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zui5buchusercrud",
									"url": sap.ui.require.toUrl("zui5buchusercrud")
								}
							}
						}
					}
